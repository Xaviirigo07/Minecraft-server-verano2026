...
1. Necesitar descargar él $\color{yellow}{\text{.zip}}$ que dice CurseForge, NO el que dice SourceCode
...
2. Descarga y extrae los archivos del $\color{yellow}{\text{.zip}}$ que dice Pirata,  NO el que dice SourceCode
